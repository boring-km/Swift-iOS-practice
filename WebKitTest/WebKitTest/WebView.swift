...
struct WebView: UIViewRepresentable, WebViewHandlerDelegate {
    ...
    func receivedJsonValueFromWebView(value: [String : Any?]) {
        print("JSON data from web: \(value)")
    }
    
    func receivedStringValueFromWebView(value: String) {
        print("String data from web: \(value)")
    }
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        configuration.userContentController.add(self.makeCoordinator(), name: handlerName)
...
extension WebView.Coordinator: WKScriptMessageHandler {
    func userContentController(_ userContentController: WKUserContentController,
        ...
        if message.name == "testHandler", let body = message.body as? [String: Any] {
